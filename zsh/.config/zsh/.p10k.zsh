# Generated by Powerlevel10k configuration wizard on 2021-07-23 at 17:56 CST.
...
# 2 lines, dotted, no frame, lightest-ornaments, compact, few icons, fluent,
# instant_prompt=off.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 150 )) && branch[13,-13]="…"  # <-- this line
